<!DOCTYPE html>
  <html>
    <head>
    <title>Update Nilai Kelas II</title>
        <meta charset="utf-8">
...
<a class="navbar-brand" href="#"><b>TPQ</b></a>
  <a class="navbar-brand btn btn-light">Update Nilai Kelas II</a>
...
<div class="container">
    <div class="jumbotron" >
      ...
      <?php
        ...
        $sql = $koneksi->query("SELECT * FROM tbl_nilai2 WHERE nis2=".$_GET['nis2']);
        //konversi data yang terdapat di dalam variabel $sql menjadi bentuk array
        $s = mysqli_fetch_array($sql);
        // var_dump($s)
        ?>
        <form action="ubahpr_nilai2.php" method="POST">
          <div class="row">
            <div class="col-sm-6">
              <label>Nis</label>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <input type="text" name="iqra_456" class="form-control"value="<?php echo $s['iqra_456']?>">
            </div>
          </div>
